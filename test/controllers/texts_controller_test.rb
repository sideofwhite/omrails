...
class TextsControllerTest < ActionController::TestCase
  ...
  test "should create text" do
    assert_difference('Text.count') do
      post :create, text: { body: @text.body, post_id: @text.post_id, subtitle: @text.subtitle, title: @text.title, user_id: @text.user_id }
    end
  ...
  test "should update text" do
    patch :update, id: @text, text: { body: @text.body, post_id: @text.post_id, subtitle: @text.subtitle, title: @text.title, user_id: @text.user_id }
    assert_redirected_to text_path(assigns(:text))
  end
